...
class Account503Controller extends Controller
 {
    ...
    public function account_503_pull(Request $request)
    {
        ...
        if ($startdate == '') { 
                $acc_debtor = DB::select(' 
                    SELECT a.acc_debtor_id,a.vn,a.an,a.hn,a.cid,a.ptname,a.vstdate,a.pttype,a.debit_total,c.subinscl,a.hospmain,a.income,a.rcpt_money,a.nationality                  
                    from acc_debtor a
    ...
    public function account_503_detail(Request $request,$months,$year)
    {
        ...
        $data = DB::select('
        SELECT U1.vn,U1.an,U1.hn,U1.cid,U1.ptname,U1.vstdate,U1.pttype,U1.debit_total,U1.hospmain,U1.hospmain,U1.income,U1.rcpt_money,U1.nationality
