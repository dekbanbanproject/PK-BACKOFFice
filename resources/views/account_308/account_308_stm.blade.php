                ...
                <div class="card cardshadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <h4 class="card-title mb-2" style="color:rgb(10, 151, 85)">  รายละเอียด 1102050101.308 STM</h4> {{-- <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
