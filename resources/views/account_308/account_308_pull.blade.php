                        ...
                        <div class="card-body shadow-lg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 text-end">
                                    <button type="button"
                                        class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info Savestamp"
                                        data-url="{{ url('account_308_stam') }}">
                                ...
                                <table id="example" class="table table-hover table-sm dt-responsive nowrap"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="5%" class="text-center"><input type="checkbox" name="stamp"
                                                    id="stamp"> </th>
                                        ...
                                        @foreach ($acc_debtor as $item)
                                            <tr id="tr_{{ $item->acc_debtor_id }}">
                                                ...
                                                {{-- @if ($item->subinscl == '')
                                                    ...
                                                    @endif --}}
                                                <td class="text-center" width="5%"><input type="checkbox" class="sub_chk"
                                                ...
                                                <td class="text-center" style="color:rgb(216, 95, 14)" width="5%">
                                                    {{ $item->subinscl }}</td>

                                                <td class="text-center" width="10%">{{ number_format($item->income, 2) }}
                                                </td>
