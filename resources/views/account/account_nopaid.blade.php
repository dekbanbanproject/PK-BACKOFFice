        ...
        <form action="{{ url('account_nopaid') }}" method="GET">
            ...
            <div class="row ms-3 me-3 mt-2"> 
                <div class="col-md-4">
                    ...
                    <p class="card-title-desc">รายละเอียดข้อมูล Visit ที่มีรายการค่าใช้จ่าย แต่ไม่มีการออกใบเสร็จ หรือลงค้าง</p>
                </div>
                <div class="col"></div>
                                ...
                                <div class="d-flex text-start">
                                    <div class="flex-grow-1 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col-md-5 text-end me-2">
                                                <a href="{{url('account_nopaid_moneysub/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                    <div class="widget-chart widget-chart-hover">
