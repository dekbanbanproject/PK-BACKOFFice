                        ...
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" >service_date_time</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($fdh_mini_dataset as $item)
                                    <?php $number++; ?>
                                        ...
                                        @endif 
                                            <td class="text-center" width="20%">{{ $item->service_date_time }}</td>
                                            <td class="text-center">{{ $item->cid }}</td>
                                            <td class="text-center">{{ $item->hcode }}</td>
                                            <td class="text-center">{{ $item->total_amout }}</td>
                                            <td class="text-center">{{ $item->invoice_number }}</td>
                                            <td class="text-center" width="20%">{{ $item->vn }}</td>
                                        </tr>
