                        ...
                        <table class="align-middle text-truncate mb-0 table table-borderless table-hover table-bordered" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">เดือนที่ตรวจ</th>
                                    <th class="text-center">ถังดับเพลิงทั้งหมดที่มี (ถัง)</th>
                                    <th class="text-center">ถังดับเพลิงที่ได้รับการตรวจสอบ (ถัง)</th>
                                    <th class="text-center">จำนวนที่ไม่ได้ตรวจรวม(ถัง)</th>
