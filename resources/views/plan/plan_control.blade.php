                ...
                <div class="card">   
                    <div class="card-header ">
                        ...
                        <div class="btn-actions-pane-right">
                            <a href="{{ url('plan_control_add') }}" class="btn-icon btn-shadow btn-dashed btn btn-sm btn-outline-info" > 
                            ...
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="example">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                                ...
                                                <div id="headingTwo" class="b-radius-0 card-header">
                                                    @if ($va->plan_name == '0')
                                                        <button type="button" data-bs-toggle="collapse"
                                                            ...
                                                            <h7 style="color: rgb(207, 204, 204)">{{ $va->plan_name }} <label for="" style="color: red"> !! รายละเอียด คลิก !!</label></h7> 
                                                        </button>
                                                    @else
                                                        <button type="button" data-bs-toggle="collapse"
                                                            data-bs-target="#collapseOne2{{ $va->plan_control_id }}" aria-expanded="false"
                                                            aria-controls="collapseTwo" class="text-start m-0 p-0 btn btn-link btn-block">
                                                            <h7 >{{ $va->plan_name }} <label for="" style="color: red"> !! รายละเอียด คลิก !!</label></h7> 
                                                        </button>
                                                    @endif
                                                ...
                                                <div data-parent="#accordion" id="collapseOne2{{ $va->plan_control_id }}" class="collapse">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row ms-3 me-3"> 
                                                                ...
                                                                <div class="col-md-2">{{$itemsub->plan_starttime}} ถึง {{$itemsub->plan_endtime}} </div>     
                                                                <div class="col-md-3">{{$itemsub->DEPARTMENT_SUB_SUB_NAME}} </div>              
                                                        </div>
                                                        @endforeach 
                                                    </div>
                                                </div> 
                                            ...
                                            <td class="text-center" width="7%">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu"> 
                                                        ...
                                                        <a href="{{url('plan_control_edit/'.$va->plan_control_id)}}"  class="dropdown-item menu "
                                                            {{-- data-bs-toggle="modal" data-bs-target="#UpdateModal{{ $va->plan_control_id }}" --}}
                                                            data-bs-toggle="tooltip" data-bs-placement="left"
                                                            title="แก้ไข">
                                                            <i class="fa-solid fa-pen-to-square ms-2 me-2 text-warning"></i>
                                        ...
                                        <div class="modal fade" id="UpdateModal{{ $va->plan_control_id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myExtraLargeModalLabel">แก้ไขทะเบียนควบคุมแผนงานโครงการ</h5><h6 class="mt-2">{{$va->billno}} </h6>
                                                        <input id="billno" class="form-control form-control-sm" name="billno" type="hidden" value="{{$va->billno}}"> 
                                                    </div>
                                                    <div class="modal-body"> 
                                                        ...
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-md-3 ">
                                                                ...
                                                                <div class="form-group">
                                                                    <input id="edit_plan_price" class="form-control form-control-sm" name="plan_price">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 ">
                                                                <label for="">แหล่งงบ </label>
                                                                <div class="form-group">
                                                                    <select name="edit_plan_type" id="edit_plan_type" class="form-control form-control-sm" style="width: 100%"> 
