                                    ...
                                    <tr id="sid{{ $item->medical_borrow_id }}">
                                        ...
                                        <td class="text-center" width="5%">
                                            ...
                                            @elseif ($item->medical_borrow_active == 'SENDEB') 
                                                <span class="badge" style="background-color: rgb(89, 10, 235);font-size:13px;color:white">ส่งคืน</span>
                                            @elseif ($item->medical_borrow_active == 'APPROVE') 
                                                <span class="badge" style="background-color: rgb(3, 150, 104);font-size:13px;color:white">จัดสรร</span>
                                            @else
                                            @endif
                                        </td>
