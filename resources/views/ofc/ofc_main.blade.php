                                            ...
                                            <tbody>
                                                ...
                                                <?php $number++; ?>
                                                    ...
                                                    <tr height="20" style="font-size: 12px;">
                                                        ...
                                                        @else
                                                            <td class="text-center" width="5%"><input type="checkbox" class="fdhcheckbox sub_chk" data-id="{{$item->d_ofc_401_id}}"> </td> 
                                                        @endif
