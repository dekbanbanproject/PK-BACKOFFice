                            ...
                            <div class="col-md-8 text-center">
                                ...
                                @if ($smartcard == 'NO_CONNECT' )
                                  ...
                                  @else
                                        ...
                                        <img src="{{ asset('images/card1.jpg') }}" alt="Image" class="img-thumbnail shadow-lg me-4" width="320px">
                                        <br><br>
                                        <label for="pid" class="form-label" style="color: rgb(197, 8, 33);font-size:30px">กรุณาเสียบบัตรประชาชน</label> <br>
                                        @else
                                        <a href="{{url('getsmartcard_authencode')}}" class="btn shadow-lg mb-4"  style="background-color: rgb(7, 222, 150)">
