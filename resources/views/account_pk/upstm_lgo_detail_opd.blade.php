        ...
        <div class="tabs-animation">
            ...
            <div class="row"> 
                ...
                <div class="col-md-2 text-end">
                    <button type="button" class="ladda-button btn-pill btn btn-primary d-shadow me-2 ms-4" data-style="expand-left">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($lgo_opd as $item_1)
                                            ...
                                            <tr height="20">
                                                ...
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px"> {{ $item_1->STMDoc }}</td>   
                                            </tr>
                                        @endforeach 
                                    </tbody> 
                                </table>
