                                            ...
                                            <tbody>
                                                ...
                                                <?php $number++; ?>
                                                    ...
                                                    <tr height="20" style="font-size: 12px;">
                                                        ...
                                                        @else
                                                            <td class="text-center" width="5%"><input type="checkbox" class="fdhcheckbox sub_chk" data-id="{{$item->d_lgo_801_id}}"> </td> 
                                                        @endif
                                                        ...
                                                        <td class="text-end" width="7%" style="font-size: 15px;color:blue">{{ number_format($item->price_lgo, 2) }}</td> 
                                                    </tr>
